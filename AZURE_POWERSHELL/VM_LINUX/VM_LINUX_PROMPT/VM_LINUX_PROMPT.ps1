...
New-AzVm -ResourceGroupName $resourceGroupName2 -Name $resourceGroupName2 -Location $location -Image $image -Size $size -OpenPorts 80 -GenerateSshKey -SshKeyName $sshKeyName
...
Get-AzPublicIpAddress -ResourceGroupName $resourceGroupName2 -Name | select "IpAddress"
